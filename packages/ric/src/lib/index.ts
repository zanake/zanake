...
export const HTML_JSX_ATTRIBUTE_MAPPING = {
    "accept": "accept",
...
export type BootstrapIconNames = keyof typeof BOOTSTRAP_ICONS;
export type HTMLAttributeNames = keyof typeof HTML_JSX_ATTRIBUTE_MAPPING;
